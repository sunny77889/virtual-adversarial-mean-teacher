...
class TROJAN:
    DIR = os.path.join('data', 'images', 'trojan')
    FILES = {
        'train': Datafile(os.path.join(DIR, 'trojan_train.mat'), 331387),
        'test': Datafile(os.path.join(DIR, 'trojan_test.mat'),36844)
    }
    VALIDATION_SET_SIZE = 33138  # 10% of the training set
    UNLABELED = -1
